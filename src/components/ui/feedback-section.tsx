...
import { MessageSquare, Star, Send, User, Mail, Phone, CheckCircle } from "lucide-react"
...
export default function FeedbackSection() {
  const [formData, setFormData] = useState({
    ...
    message: "",
    rating: 0,
    type: "parent", // parent, student, alumni, visitor
  })
      ...
      <div className="container mx-auto px-4 pt-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-[#5a3e36] max-w-2xl mx-auto">
            We value your opinions and suggestions to continuously improve our services and
            ...
            <div className="md:flex">
              <div className="md:w-1/3 bg-gradient-to-br from-[#8b1a1a] to-[#a52a2a] p-8 text-white">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/90">aryavartaa.krd@gmail.com</p>
                    </div>
                  </div>
                ...
                <div className="mt-8">
                  ...
                  <p className="text-sm text-white/70 mt-1">- William Butler Yeats</p>
                </div>
              </div>
                ...
                <AnimatePresence mode="wait">
                  {isSubmitted ? (
                    ...
                    >
                      ...
                      <h3 className="text-xl font-bold text-[#8b1a1a] mb-2">Thank You!</h3>
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-medium text-[#5a3e36] mb-1">Name</label>
                          <div className="relative">
