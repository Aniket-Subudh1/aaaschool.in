    ...
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 font-serif">The Aryavart Houses</h2>
          <p className="text-white/90 max-w-2xl mx-auto">
            35 acres Campus with a green environment. Total Capacity on campus 1200. Teacher : Student Ratio 1:20
          </p>
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{ backgroundColor: house.color, boxShadow: `0 0 20px ${house.color}80` }}
                >
                  {house.icon}
                </div>
                ...
                <div className="pt-10 px-6 pb-4">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-white/80 italic text-sm">{house.title}</p>
                  </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-16 opacity-20 pointer-events-none">
          <svg viewBox="0 0 1200 100" preserveAspectRatio="none" className="w-full h-full">
            <path d="M0,0 C300,95 900,95 1200,0 L1200,100 L0,100 Z" fill="white" />
          </svg>
        </div>
      </div>
    </section>
