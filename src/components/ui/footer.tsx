        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 w-full md:w-auto">
            ...
            <div className="flex flex-col items-center py-3 md:py-5 px-4 md:px-6">
              ...
              <h4 className="text-[#5a3e36] font-medium text-sm md:text-base text-center">Address</h4>
              <p className="text-gray-600 text-xs md:text-sm text-center">
                Plot no 684, Haladipada,<br />
                Khorda, Pin-752056
              </p>
            </div>
            ...
            <div className="flex flex-col items-center py-3 md:py-5 px-4 md:px-6">
              ...
              <h4 className="text-[#5a3e36] font-medium text-sm md:text-base text-center">Phone Number</h4>
              <p className="text-gray-600 text-xs md:text-sm text-center">9124654094</p>
            </div>
            ...
            <div className="flex flex-col items-center py-3 md:py-5 px-4 md:px-6">
              ...
              <h4 className="text-[#5a3e36] font-medium text-sm md:text-base text-center">Email Address</h4>
              <p className="text-gray-600 text-xs md:text-sm text-center">
                aryavartaa.krd@gmail.com<br />
