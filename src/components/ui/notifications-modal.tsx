...
export default function NotificationsModal() {
  ...
  return (
    <>
      <button 
        onClick={openModal}
        className="flex items-center text-[#5a3e36] hover:text-[#8b1a1a] transition-colors"
      >
            ...
            >
              ...
              <div className="bg-gradient-to-r from-[#8b1a1a] to-[#a52a2a] text-white p-6 flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <h2 className="text-xl font-bold">AAA Notifications</h2>
                </div>
                <button 
                  onClick={closeModal}
                        ...
                        <div className="flex items-start">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-[#5a3e36] mt-2 opacity-70">
                              Posted on {new Date(notification.createdAt).toLocaleDateString('en-US', {
                                year: 'numeric',
                                month: 'long',
                                day: 'numeric'
                              })}
