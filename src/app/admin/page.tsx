  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const newFeedback = feedbackArray.filter(
          (f: any) => f.status === "new"
        ).length;
        const respondedFeedback = feedbackArray.filter(
          (f: any) => f.status === "responded"
        ).length;
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-[#5a3e36]">
          Welcome to the Aryavart Ancient Academy admin panel. Manage your
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div>
          <h2 className="text-xl font-bold text-[#8b1a1a] mb-4">
            Quick Actions
          </h2>
