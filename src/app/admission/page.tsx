      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-gray-700 max-w-2xl mx-auto">
            Welcome to Aryavart Ancient Academy&apos;s admission portal. Follow
            the steps below to apply for admission.
          </p>
        </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-2 text-gray-600">
                    Fill out the admission enquiry form with basic details about
                    the student and parent. Our team will review your enquiry
                    and provide an enquiry number if approved.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-2 text-gray-600">
                    ...
                    information about the student, parents, previous education,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow">
            <div className="p-6 md:p-8">
              ...
              <p className="text-gray-600 text-center mb-6">
                If you already have an approved enquiry number, proceed to fill
                out the complete admission form.
              </p>
              <Link
        ...
        <div className="mt-12 text-center">
          <h2 className="text-2xl font-bold text-[#8b1a1a] mb-4">Need Help?</h2>
