...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log(
        "Token received:",
        data.token ? data.token.substring(0, 10) + "..." : "None"
      );
    ...
    <div className="min-h-screen -mt-24 flex items-center justify-center bg-[#f8f3e9]">
      ...
      <div className="w-full max-w-md p-8 bg-white rounded-xl shadow-lg relative z-10 border border-[#d4b483]/30">
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="mt-4 text-2xl font-bold text-[#8b1a1a]">
            Admin Login
          </h2>
          <p className="text-[#5a3e36] mt-1">
        ...
        <div className="mt-6 text-center text-sm text-[#5a3e36]">
          <p>
            For security reasons, only authorized personnel are allowed to
            access this area.
          </p>
        </div>
      </div>
